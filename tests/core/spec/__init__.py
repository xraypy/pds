...
# ----------------------------------------------------------------------------------
# Project: pds
# File: tests/core/spec/__init__.py
# ----------------------------------------------------------------------------------
# Purpose:
# SPEC test package: tests for pds.core.spec and pds.model. Exposes shared
# pytest fixtures (minimal_spec_lines, minimal_spec_content,
# minimal_spec_lines_one_scan) for use by test modules.
# ----------------------------------------------------------------------------------
...
@pytest.fixture
def minimal_spec_content(minimal_spec_lines):
