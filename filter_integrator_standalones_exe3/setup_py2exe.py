...
extra_files = ["inno_setup.iss", "../COPYING", "../README.txt", "../bin/GSEMap.ico", "../bin/larch.ico", "../bin/ptable.ico"]
scipy_dlls = [
    "lib/site-packages/scipy/optimize/minpack2.pyd",
...
py2exe_opts = {
    ...
    "packages": ["h5py", "scipy.optimize", "scipy.signal", "scipy.io", "numpy.random", "xml.etree", "xml.etree.cElementTree"],
    "excludes": [
        "Tkinter",
        "_tkinter",
        "Tkconstants",
...
setup(name="GSE_CTR", windows=windows_apps, options={"py2exe": py2exe_opts}, data_files=mpl_data_files)
